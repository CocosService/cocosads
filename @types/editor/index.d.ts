...
export declare class BaseEditor {
    get remote(): any;
    Dialog: {
        select(options?: import("./dialog/public/interface").SelectDialogOptions, window?: Electron.BrowserWindow): any;
        save(options?: import("./dialog/public/interface").SelectDialogOptions, window?: Electron.BrowserWindow): any;
        info(message: string, options?: import("./dialog/public/interface").MessageDialogOptions, window?: Electron.BrowserWindow): any;
        warn(message: string, options?: import("./dialog/public/interface").MessageDialogOptions, window?: Electron.BrowserWindow): any;
        error(message: string, options?: import("./dialog/public/interface").MessageDialogOptions, window?: Electron.BrowserWindow): any;
    };
    EditMode: {
    ...
    Profile: {
        getConfig(name: string, key?: string, type?: import("./profile/public/interface").preferencesProtocol): any;
        setConfig(name: string, key: string, value: any, type?: import("./profile/public/interface").preferencesProtocol): any;
        removeConfig(name: string, key: string, type?: import("./profile/public/interface").preferencesProtocol): any;
        getProject(name: string, key?: string, type?: import("./profile/public/interface").projectProtocol): any;
        setProject(name: string, key: string, value: any, type?: import("./profile/public/interface").projectProtocol): any;
        removeProject(name: string, key: string, type?: import("./profile/public/interface").projectProtocol): any;
        getTemp(name: string, key?: string): any;
        setTemp(name: string, key: string, value: any): any;
        removeTemp(name: string, key: string): any;
        on(action: string, handle: Function): any;
        once(action: string, handle: Function): any;
        removeListener(action: string, handle: Function): any;
    };
